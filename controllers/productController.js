...
export const createProductContrller = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      case photo && photo.size > 100000:
        return res.status(500).send({
          error: "photo  is required and size should be less tha 1 mb",
        });
    }
...
export const reltedProductController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in while searching releted product",
      error,
    });
  }
};
